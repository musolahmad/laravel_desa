      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-8 col-sm-8 col-xs-12">
            <div class="row">
              @if(session('cari'))
              <form method="post" action="{{url('')}}/" class="col-md-12 col-sm-12 col-xs-12">
                  @csrf
                  <div class="alert alert-success alert-block">
                  <button type="submit" class="close">×</button>
                  Hasil Pencarian "<strong>{{ session('cari') }}</strong>"
                </div>
                </form>
                  ...
                  <div class="single-blog">
                    <div class="blog-text">
                      ...
                      <div class="error-details">
                          Maaf, Tidak ada berita atau artikel yang sesuai dengan hasil pencarian!
                      </div>
                    </div>
                  </div>
                  <div class="form contact-form">
                    <div class="text-center">
                       <form method="post" action="{{url('')}}/">
                        @csrf
                        <button class="ready-btn btn-danger" type="submit">Halaman Utama</button>  
                      </form>
                    </div>
                  </div>
              </div>
