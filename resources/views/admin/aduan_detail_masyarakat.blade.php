    ...
    <div class="container"> 
        ...
        <!-- Form START -->
            ...
            <div class="col s12 m8">
                ...
                @endif
                <a type="button" href="{{url('')}}/masyarakat/{{$berita->kd_user}}" class="btn small blue-grey waves-effect waves-light white-text"><i class="material-icons">arrow_back</i> Kembali</a>
