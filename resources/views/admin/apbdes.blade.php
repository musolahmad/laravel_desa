                ...
                <div class="z-depth-1">
                    <nav class="secondary-nav">
                        <div class="nav-wrapper blue-grey darken-1">
                            <div class="col m12">
                                <ul class="left">
                                    <li class="waves-effect waves-light"><a href="" class="judul"><i class="material-icons">book</i> APBDes Tahun {{$th}}</a></li>
                                </ul>
                            </div>
                        </div>
                    </nav>
        ...
        <div class="col m12" id="colres">
            ...
            <div id="modal" class="modal">
                <div class="modal-content white">
                    ...
                    <div class="row">
                        <form method="post" action="{{url('')}}/apbdes">
            ...
            <table class="bordered" id="tbl">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @if($m->tipe_akun==2)
                                <a class="btn small green waves-effect waves-light modal-trigger" href="#m" onclick="edit('{{$m->kd_rekening}}','{{$m->uraian}}','@if(empty($pagu)){{"0"}}@else{{number_format($pagu->pagu_rencana,0,',','.')}}@endif','{{$th}}','{{$m->kd_induk}}');" title="Edit Data"><i class="material-icons">edit</i> Edit</a> 
                            @endif    
                        </td>
                    </tr>
                    @endforeach
                    @if($master->isEmpty())
                        <tr><td colspan="4"><center><p class="add">Tidak ada data yang ditemukan. <u><a href="#modal" class="modal-trigger">Tambah data baru</a></u></p></center></td></tr>
                    @endif
                </tbody>
            </table>
            <div id="m" class="modal">
                <div class="modal-content white">
                    ...
                    <div class="row">
                        <form method="post" action="{{url('')}}/apbdes/apbdes">
                            @csrf
                            <div class="input-field col s12">
