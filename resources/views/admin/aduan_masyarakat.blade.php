...
<main>
    ...
    <div class="container"> 
                ...
                <div class="z-depth-1">
                    <nav class="secondary-nav">
                        <div class="nav-wrapper blue-grey darken-1">
                            <div class="col m7">
                                <ul class="left">
                                    <li class="waves-effect waves-light hide-on-small-only"><a href="" class="judul"><i class="material-icons">mail</i> Aduan dari {{$user->nama_depan}} {{$user->nama_belakang}}</a></li>
                                    <li class="waves-effect waves-light"><a href="{{url('')}}/masyarakat/aduan"><i class="material-icons">arrow_back</i> Kembali</a></li>                                    
                                </ul>
                            </div>
                        </div>
                    </nav>
        ...
        <div class="col m12" id="colres">
            <label class="right">{{$total}} Data Aduan</label>  
            <table class="bordered" id="tbl">
                    ...
                    <tr>
                        ...
                        <div id="modaljml" class="modal">
                            <div class="modal-content white">
                                ...
                                <div class="row">
                                    <form method="post" action="{{url('')}}/masyarakat/halaman">
                ...
                <tbody>
                    ...
                    <tr style="color: @if($brt->baca=='1'){{'red'}}@endif" >
                        ...
                        <td>
                            <a class="btn small green waves-effect waves-light " href="{{url('')}}/masyarakat/{{$brt->kd_aduan}}"><i class="material-icons">remove_red_eye</i> Baca Selengkapnya</a>
                        </td>
                    </tr>
                    @endforeach
                    @if($berita->isEmpty())
                        <tr><td colspan="4"><center><p class="add">Tidak ada data aduan yang ditemukan.</p></center></td></tr>
                    @endif
                </tbody>
            </table>           
        </div>
